#ifndef win_util_acrylic_compositor_h
#define win_util_acrylic_compositor_h
...
namespace Acrylic {
    ...
    class AcrylicCompositor {
      public:
        enum BackdropSource { BACKDROP_SOURCE_DESKTOP = 0x0, BACKDROP_SOURCE_HOSTBACKDROP = 0x1 };
        ...
        static std::unique_ptr<AcrylicCompositor> Create(unsigned long buildVersion);
...
#pragma endregion
        ...
        typedef HRESULT(WINAPI *DwmpCreateSharedThumbnailVisual)(IN HWND hwndDestination, IN HWND hwndSource, IN DWORD dwThumbnailFlags,
                                                                 IN DWM_THUMBNAIL_PROPERTIES *pThumbnailProperties, IN VOID *pDCompDevice,
                                                                 OUT VOID **ppVisual, OUT PHTHUMBNAIL phThumbnailId);
        typedef HRESULT(WINAPI *DwmpCreateSharedMultiWindowVisual)(IN HWND hwndDestination, IN VOID *pDCompDevice, OUT VOID **ppVisual,
                                                                   OUT PHTHUMBNAIL phThumbnailId);
        typedef HRESULT(WINAPI *DwmpUpdateSharedMultiWindowVisual)(IN HTHUMBNAIL hThumbnailId, IN HWND *phwndsInclude, IN DWORD chwndsInclude,
                                                                   IN HWND *phwndsExclude, IN DWORD chwndsExclude, OUT RECT *prcSource,
                                                                   OUT SIZE *pDestinationSize, IN DWORD dwFlags);
        typedef HRESULT(WINAPI *DwmpCreateSharedVirtualDesktopVisual)(IN HWND hwndDestination, IN VOID *pDCompDevice, OUT VOID **ppVisual,
                                                                      OUT PHTHUMBNAIL phThumbnailId);
        typedef HRESULT(WINAPI *DwmpUpdateSharedVirtualDesktopVisual)(IN HTHUMBNAIL hThumbnailId, IN HWND *phwndsInclude, IN DWORD chwndsInclude,
                                                                      IN HWND *phwndsExclude, IN DWORD chwndsExclude, OUT RECT *prcSource,
      ...
      public:
        AcrylicCompositor(unsigned long buildVersion, DwmpCreateSharedThumbnailVisual DwmCreateSharedThumbnailVisual,
                          DwmpCreateSharedMultiWindowVisual DwmCreateSharedMultiWindowVisual,
                          DwmpUpdateSharedMultiWindowVisual DwmUpdateSharedMultiWindowVisual,
                          DwmpCreateSharedVirtualDesktopVisual DwmCreateSharedVirtualDesktopVisual,
                          DwmpUpdateSharedVirtualDesktopVisual DwmUpdateSharedVirtualDesktopVisual,
